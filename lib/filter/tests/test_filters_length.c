  ...
  static FilterParamLength test_data_list[] =
    {
        ...
        {.msg = "abc", .length = 3, .expected_result = TRUE},
        {.msg = "abc", .length = 4, .expected_result = FALSE},
        {.msg = "", .length = , .expected_result = },
        {.msg = "", .length = , .expected_result = },
        {.msg = "", .length = , .expected_result = },
    };
...
ParamterizedTest(FilterParamLength *param, filter, test_filter_length);
